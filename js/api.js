...
const API_KEY = "df4db72cbc114ae9a1edf7e19f7315b1";
...
function getStanding() {
    return new Promise((resolve,reject)=>{
        if ("caches" in window) {
         ...
         fetchApi(baseUrl + "/v2/competitions/2021/standings")
            .then(statusResponse)
            .then(json)
            .then(data => resolve(data)).catch(error=>reject(error));
    });
...
function getMatch() {
    return new Promise((resolve, reject) => {
        ...
        fetchApi(baseUrl + "/v2/teams/66/matches?status=SCHEDULED")
            .then(statusResponse)
            .then(json)
            .then(data => resolve(data)).catch(error => reject(error));
    });
...
function getMatchId(id) {
    return new Promise((resolve,reject)=>{
        ...
        fetchApi(baseUrl + "/v2/matches/" + id)
            .then(statusResponse)
            .then(json)
